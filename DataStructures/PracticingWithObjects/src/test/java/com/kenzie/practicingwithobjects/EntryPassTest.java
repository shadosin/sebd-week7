...
public class EntryPassTest {
    ...
    static final Object[] ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345 = {"Homer", "12345"};

    static final Object[] ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_34567 = {"Homer", "34567"};
    static final Class<?>[] TWO_PARAMETER_CONSTRUCTOR_TYPE = {String.class, String.class};

    static final Object[] ENTRY_PASS_DATA_ONE_VIP_ACCESS = {"Homer", "12345", "VIP"};
    static final Object[] ENTRY_PASS_DATA_ONE_STANDARD_ACCESS = {"Homer", "34567", "standard"};

    static final Class<?>[] THREE_PARAMETER_CONSTRUCTOR_TYPE = {String.class, String.class, String.class};

    static final String CLASS_NAME = "EntryPass";
    ...
    void classHasField_name_Test() {
        ...
        try {
            getFieldValueInClassUsingReflection(fieldNameToFind, ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345, TWO_PARAMETER_CONSTRUCTOR_TYPE);
            assertTrue(true);
        } catch (Exception e) {
    ...
    void entryPassClass_nameField_usesPrivateModifier_Test() {
        ...
        try {
            getFieldValueInClassUsingReflection(fieldNameToFind, ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345, TWO_PARAMETER_CONSTRUCTOR_TYPE);
            assertTrue(doesClassFieldUseCorrectModifier(fieldNameToFind, ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345, TWO_PARAMETER_CONSTRUCTOR_TYPE, "PRIVATE"), "Please Double check that your field " + fieldNameToFind + " uses the " + EXPECTED_MODIFIER + "modifier.");
        } catch (Exception e) {
    ...
    void entryPass_twoParameterConstructor_Exists() {
        try {
            ...
            Constructor<EntryPass> cons = entryPassClass.getConstructor(TWO_PARAMETER_CONSTRUCTOR_TYPE);
    ...
    void entryPass_threeParameterConstructor_Exists() {
        try {
            ...
            Class<EntryPass> entryPassClass = EntryPass.class;
            Constructor<EntryPass> cons = entryPassClass.getConstructor(THREE_PARAMETER_CONSTRUCTOR_TYPE);
            EntryPass instance = cons.newInstance(params);
    ...
    public void testEntryPassEqualityReflexivity_Two_ParameterConstructor_Test() {
        try {
            Constructor entryPassConstructor = EntryPass.class.getConstructor(TWO_PARAMETER_CONSTRUCTOR_TYPE);
            EntryPass e1 = (EntryPass) entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345);
    ...
    public void testEntryPassEqualityReflexivity_Three_ParameterConstructor_Test() {
        try {
            Constructor entryPassConstructor = EntryPass.class.getConstructor(THREE_PARAMETER_CONSTRUCTOR_TYPE);
            EntryPass e1 = (EntryPass) entryPassConstructor.newInstance(ENTRY_PASS_DATA_ONE_VIP_ACCESS);
            assertTrue(e1.equals(e1));
        } catch (Exception e) {
            System.out.println(e.toString());
            fail("EntryPass and all setter/getter methods must be defined");
    ...
    public void testEntryPassEqualitySymmetry_Two_ParameterConstructor_Test() {
        try {
            Constructor<EntryPass> entryPassConstructor = EntryPass.class.getConstructor(TWO_PARAMETER_CONSTRUCTOR_TYPE);
            EntryPass e1 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345);
            EntryPass e2 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345);
    ...
    public void testEntryPassEqualitySymmetry_Three_ParameterConstructor_Test() {
        try {
            Constructor<EntryPass> entryPassConstructor = EntryPass.class.getConstructor(THREE_PARAMETER_CONSTRUCTOR_TYPE);
            EntryPass e1 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_ONE_VIP_ACCESS);
            EntryPass e2 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_ONE_VIP_ACCESS);
            assertTrue(e1.equals(e2));
            assertTrue(e2.equals(e1));
        } catch (Exception e) {
            System.out.println(e.toString());
    ...
    public void testEntryPassEqualityTransitivity_Two_ParameterConstructor_Test() {
        try {
            ...
            EntryPass e1 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345);
            EntryPass e2 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345);
            EntryPass e3 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345);
            assertTrue(e1.equals(e2));
    ...
    public void testEntryPassEqualityTransitivity_Three_ParameterConstructor_Test() {
        try {
            ...
            EntryPass e1 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_ONE_VIP_ACCESS);
            EntryPass e2 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_ONE_VIP_ACCESS);
            EntryPass e3 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_ONE_VIP_ACCESS);
            assertTrue(e1.equals(e2));
            assertTrue(e2.equals(e3));
            assertTrue(e1.equals(e3));
        } catch (Exception e) {
    ...
    public void testEntryPassEqualityConsistency_Two_ParameterConstructor_Test() {
        try {
            ...
            e1 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345);
            e2 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345);
            assertTrue(e1.equals(e2));
            assertTrue(e1.equals(e2));
        } catch (Exception e) {
            System.out.println(e.toString());
    ...
    public void testEntryPassEqualityConsistency_Three_ParameterConstructor_Test() {
        try {
            ...
            e1 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_ONE_VIP_ACCESS);
            e2 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_ONE_VIP_ACCESS);
            assertTrue(e1.equals(e2));
            assertTrue(e1.equals(e2));
        } catch (Exception e) {
            System.out.println(e.toString());
    ...
    public void testEntryPassEqualityNonNullity_Two_ParameterConstructor_Test() {
        try {
            Constructor<EntryPass> entryPassConstructor = EntryPass.class.getConstructor(TWO_PARAMETER_CONSTRUCTOR_TYPE);
            EntryPass e1 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_34567);
    ...
    public void testEntryPassEqualityNotEqual_Two_ParameterConstructor_Test() {
        try {
            Constructor<EntryPass> entryPassConstructor = EntryPass.class.getConstructor(TWO_PARAMETER_CONSTRUCTOR_TYPE);
            EntryPass e1 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_12345);
            EntryPass e2 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_TWO_GENERAL_ACCESS_ID_34567);
    ...
    public void testEntryPassEqualityNotEqual_Three_ParameterConstructor_Test() {
        try {
            Constructor<EntryPass> entryPassConstructor = EntryPass.class.getConstructor(THREE_PARAMETER_CONSTRUCTOR_TYPE);
            EntryPass e1 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_ONE_VIP_ACCESS);
            EntryPass e2 = entryPassConstructor.newInstance(ENTRY_PASS_DATA_ONE_STANDARD_ACCESS);
            assertFalse(e1.equals(e2));
        } catch (Exception e) {
            System.out.println(e.toString());
            fail("EntryPass and all setter/getter methods must be defined");
