...
public class ApplicationTest {
    ...
    public void testGetVIPList_VIPFound_2() {
        ...
        try {
            Constructor entryPassConstructor = EntryPass.class.getConstructor(paramTypes);
            EntryPass entryPassHomerVip = (EntryPass) entryPassConstructor.newInstance(new Object[]{"Amanda","12345","vip"});
            EntryPass entryPassMaggieVip = (EntryPass) entryPassConstructor.newInstance(new Object[]{"Marlena","25840","special"});
            EntryPass entryPassMargeGeneral = (EntryPass) entryPassConstructor.newInstance(new Object[]{"Sarah","96301","general"});
